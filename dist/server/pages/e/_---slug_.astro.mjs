...
const ALLOWED_EXTENSIONS = /* @__PURE__ */ new Set([".png", ".jpg", ".jpeg", ".gif", ".webp", ".svg", ".ico", ".js", ".mjs", ".css", ".json", ".wasm", ".mp3", ".ogg", ".wav", ".mp4", ".webm", ".ttf", ".woff", ".woff2", ".eot", ".unityweb", ".data", ".mem", ".symbols"]);
